...
const rangePlaces = (n: number): string[] => Array.from({ length: n }, (_, i) => String(i + 1));
export const PRIZE_PLACES = rangePlaces(3);
export const LEAD_FINAL_PLACES = rangePlaces(10);
export const BOULDER_FINAL_PLACES = rangePlaces(12);
